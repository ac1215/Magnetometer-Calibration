...
static void add_magcal_data(const int32_t *data)
{
	int i;
...
int getMagcalibration(float *cal_data_sent)
{
	int i;

	for (i=0; i < 3; i++) {
		cal_data_sent[0+i] = magcal.V[i];
	}

	cal_data_sent[4] = magcal.B;
	cal_data_sent[5] = magcal.invW[0][0];
	cal_data_sent[6] = magcal.invW[0][1];
	cal_data_sent[7] = magcal.invW[0][2];
	cal_data_sent[8] = magcal.invW[1][0];
	cal_data_sent[9] = magcal.invW[1][1];
	cal_data_sent[10] = magcal.invW[1][2];
	cal_data_sent[11] = magcal.invW[2][0];
	cal_data_sent[12] = magcal.invW[2][1];
	cal_data_sent[13] = magcal.invW[2][2];
